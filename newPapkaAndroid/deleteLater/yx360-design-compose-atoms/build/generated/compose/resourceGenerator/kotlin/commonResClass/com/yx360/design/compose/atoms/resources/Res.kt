...
public object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/com.yx360.design.compose.atoms.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/com.yx360.design.compose.atoms.resources/" + path)
