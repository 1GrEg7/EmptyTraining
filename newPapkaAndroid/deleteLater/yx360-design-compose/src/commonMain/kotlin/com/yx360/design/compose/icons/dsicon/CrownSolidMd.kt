...
public val DsIcon.CrownSolidMd: ImageVector
    get() {
        if (_crownSolidMd != null) {
            return _crownSolidMd!!
        }
        _crownSolidMd = Builder(name = "CrownSolidMd", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.389f, 8.453f)
...
private var _crownSolidMd: ImageVector? = null
