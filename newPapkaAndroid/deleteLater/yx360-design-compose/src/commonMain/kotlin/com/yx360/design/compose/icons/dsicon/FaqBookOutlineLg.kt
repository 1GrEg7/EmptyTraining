...
public val DsIcon.FaqBookOutlineLg: ImageVector
    get() {
        if (_faqBookOutlineLg != null) {
            return _faqBookOutlineLg!!
        }
        _faqBookOutlineLg = Builder(name = "FaqBookOutlineLg", defaultWidth = 32.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(24.319f)
                horizontalLineTo(5.004f)
                curveTo(5.001f, 24.375f, 5.0f, 24.43f, 5.0f, 24.486f)
                curveTo(5.0f, 26.427f, 6.573f, 28.0f, 8.514f, 28.0f)
                horizontalLineTo(27.371f)
                verticalLineTo(26.0f)
                horizontalLineTo(25.857f)
                verticalLineTo(22.929f)
                curveTo(26.577f, 22.761f, 27.114f, 22.115f, 27.114f, 21.343f)
                verticalLineTo(5.629f)
                curveTo(27.114f, 4.729f, 26.385f, 4.0f, 25.486f, 4.0f)
                horizontalLineTo(8.514f)
                close()
                moveTo(23.857f, 22.971f)
                horizontalLineTo(8.514f)
                curveTo(7.678f, 22.971f, 7.0f, 23.649f, 7.0f, 24.486f)
                curveTo(7.0f, 25.322f, 7.678f, 26.0f, 8.514f, 26.0f)
                horizontalLineTo(23.857f)
                verticalLineTo(22.971f)
                close()
                moveTo(8.514f, 20.971f)
                curveTo(7.972f, 20.971f, 7.459f, 21.094f, 7.0f, 21.313f)
                verticalLineTo(7.514f)
                curveTo(7.0f, 6.678f, 7.678f, 6.0f, 8.514f, 6.0f)
...
private var _faqBookOutlineLg: ImageVector? = null
