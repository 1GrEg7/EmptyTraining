...
public val DsIcon.LockSolidMd: ImageVector
    get() {
        if (_lockSolidMd != null) {
            return _lockSolidMd!!
        }
        _lockSolidMd = Builder(name = "LockSolidMd", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.109f, 11.156f, 17.055f, 11.142f, 17.0f, 11.129f)
                verticalLineTo(7.0f)
                ...
                curveTo(9.156f, 11.0f, 9.322f, 11.0f, 9.5f, 11.0f)
                horizontalLineTo(14.5f)
                curveTo(14.678f, 11.0f, 14.844f, 11.0f, 15.0f, 11.0f)
                close()
            }
        }
        .build()
...
private var _lockSolidMd: ImageVector? = null
