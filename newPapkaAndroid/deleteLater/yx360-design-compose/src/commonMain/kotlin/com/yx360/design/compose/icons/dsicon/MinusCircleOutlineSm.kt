...
public val DsIcon.MinusCircleOutlineSm: ImageVector
    get() {
        if (_minusCircleOutlineSm != null) {
            return _minusCircleOutlineSm!!
        }
        _minusCircleOutlineSm = Builder(name = "MinusCircleOutlineSm", defaultWidth = 16.0.dp,
...
private var _minusCircleOutlineSm: ImageVector? = null
