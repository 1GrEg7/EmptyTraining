...
public val DsIcon.ZoomOutOutlineSm: ImageVector
    get() {
        if (_zoomOutOutlineSm != null) {
            return _zoomOutOutlineSm!!
        }
        _zoomOutOutlineSm = Builder(name = "ZoomOutOutlineSm", defaultWidth = 16.0.dp, defaultHeight
...
private var _zoomOutOutlineSm: ImageVector? = null
