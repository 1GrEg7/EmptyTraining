...
public val DsIcon.InfoOutlineSm: ImageVector
    get() {
        if (_infoOutlineSm != null) {
            return _infoOutlineSm!!
        }
        _infoOutlineSm = Builder(name = "InfoOutlineSm", defaultWidth = 16.0.dp, defaultHeight =
                16.0.dp, viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.57f, 12.586f)
                curveTo(6.545f, 12.586f, 6.208f, 11.958f, 6.208f, 11.377f)
                curveTo(6.208f, 11.132f, 6.285f, 10.765f, 6.346f, 10.551f)
                lineTo(6.95f, 8.061f)
                horizontalLineTo(6.16f)
                curveTo(5.999f, 8.061f, 5.88f, 7.911f, 5.917f, 7.755f)
                lineTo(5.994f, 7.424f)
                curveTo(6.025f, 7.29f, 6.132f, 7.187f, 6.266f, 7.16f)
                lineTo(8.623f, 6.687f)
                curveTo(8.983f, 6.615f, 9.296f, 6.942f, 9.207f, 7.298f)
                lineTo(8.251f, 11.13f)
                curveTo(8.229f, 11.22f, 8.274f, 11.313f, 8.359f, 11.35f)
                curveTo(8.436f, 11.384f, 8.526f, 11.364f, 8.581f, 11.301f)
                lineTo(9.449f, 10.298f)
                curveTo(9.555f, 10.175f, 9.735f, 10.15f, 9.871f, 10.238f)
                curveTo(10.026f, 10.338f, 10.067f, 10.546f, 9.961f, 10.697f)
                lineTo(9.559f, 11.27f)
                curveTo(8.825f, 12.341f, 8.151f, 12.586f, 7.57f, 12.586f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var _infoOutlineSm: ImageVector? = null
