...
public val DsIcon.CrownOutlineLg: ImageVector
    get() {
        if (_crownOutlineLg != null) {
            return _crownOutlineLg!!
        }
        _crownOutlineLg = Builder(name = "CrownOutlineLg", defaultWidth = 32.0.dp, defaultHeight =
                32.0.dp, viewportWidth = 32.0f, viewportHeight = 32.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(17.021f, 8.799f)
                ...
                close()
                moveTo(12.854f, 16.014f)
                curveTo(14.401f, 15.612f, 15.392f, 14.738f, 16.01f, 13.684f)
                curveTo(16.625f, 14.738f, 17.612f, 15.612f, 19.158f, 16.014f)
                curveTo(21.385f, 16.594f, 23.379f, 15.854f, 24.88f, 14.632f)
                lineTo(23.887f, 22.934f)
                horizontalLineTo(8.125f)
                lineTo(7.132f, 14.632f)
                curveTo(8.633f, 15.854f, 10.628f, 16.594f, 12.854f, 16.014f)
                close()
            }
        }
        .build()
...
private var _crownOutlineLg: ImageVector? = null
