...
public val DsIcon.ChatSolidLg: ImageVector
    get() {
        if (_chatSolidLg != null) {
            return _chatSolidLg!!
        }
        _chatSolidLg = Builder(name = "ChatSolidLg", defaultWidth = 32.0.dp, defaultHeight =
...
private var _chatSolidLg: ImageVector? = null
