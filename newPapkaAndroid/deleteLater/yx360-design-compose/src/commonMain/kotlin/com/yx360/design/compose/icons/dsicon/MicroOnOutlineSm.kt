...
public val DsIcon.MicroOnOutlineSm: ImageVector
    get() {
        if (_microOnOutlineSm != null) {
            return _microOnOutlineSm!!
        }
        _microOnOutlineSm = Builder(name = "MicroOnOutlineSm", defaultWidth = 16.0.dp, defaultHeight
...
private var _microOnOutlineSm: ImageVector? = null
