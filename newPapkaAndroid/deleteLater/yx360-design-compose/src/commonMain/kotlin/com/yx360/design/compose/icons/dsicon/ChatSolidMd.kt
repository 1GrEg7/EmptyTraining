...
public val DsIcon.ChatSolidMd: ImageVector
    get() {
        if (_chatSolidMd != null) {
            return _chatSolidMd!!
        }
        _chatSolidMd = Builder(name = "ChatSolidMd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _chatSolidMd: ImageVector? = null
