...
public val DsIcon.MinusCircleSolidMd: ImageVector
    get() {
        if (_minusCircleSolidMd != null) {
            return _minusCircleSolidMd!!
        }
        _minusCircleSolidMd = Builder(name = "MinusCircleSolidMd", defaultWidth = 24.0.dp,
...
private var _minusCircleSolidMd: ImageVector? = null
