...
public val DsIcon.MicroOnSolidMd: ImageVector
    get() {
        if (_microOnSolidMd != null) {
            return _microOnSolidMd!!
        }
        _microOnSolidMd = Builder(name = "MicroOnSolidMd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _microOnSolidMd: ImageVector? = null
