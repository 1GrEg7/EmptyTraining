...
public val DsIcon.TimeOutlineSm: ImageVector
    get() {
        if (_timeOutlineSm != null) {
            return _timeOutlineSm!!
        }
        _timeOutlineSm = Builder(name = "TimeOutlineSm", defaultWidth = 16.0.dp, defaultHeight =
...
private var _timeOutlineSm: ImageVector? = null
