...
public val DsIcon.SuccessOutlineMd: ImageVector
    get() {
        if (_successOutlineMd != null) {
            return _successOutlineMd!!
        }
        _successOutlineMd = Builder(name = "SuccessOutlineMd", defaultWidth = 24.0.dp, defaultHeight
...
private var _successOutlineMd: ImageVector? = null
